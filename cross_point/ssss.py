...
testPath = r"E:\111_4_26_test_img\201907141524_0002.jpg"
print(testPath)
...
print(imgIter)
cv2.imwrite(r"E:\111_4_26_test_img\bin.tif",imgBin)
cv2.imwrite(r"E:\111_4_26_test_img\jft.png",imgIter)
    ...
    for y in range(box[1], box[3]):
        for x in range(box[0], box[2]):
            ...
            for n in range(top, bottom+1):
                fontCount = npJft[n+1][right] + npJft[n][left] - npJft[n][right] - npJft[n+1][left]   # 积分图
                if (fontCount != 0):
                    oneCount += 1
...
cv2.imwrite(r"E:\111_4_26_test_img\cor.png", imgCor)
plt_imshow(imgCor)
