...
def fld_demo4(image, sheet_dict, split_x, name, save_path):
    ...
    point_direction_list = judge_cross_point_and_direction(points_list_new_y, image, name, thresh=15, pixel_thresh=1000)
...
if __name__ == '__main__':
    ...
    for ele in img_list:
        if ele.endswith('.jpg'):
            ...
            # cv2.imwrite(os.path.join(r'E:\111_4_26_test_img\aa\save4', ele), image_)
            name = ele.split('.')[0]
